...
export default function Hero() {
    return (
      <div className="flex-col min-h-screen w-screen p-2 md:px-20 md:pt-32">
        ...
        <div className="flex items-center">
          ...
          <div className="px-2 overflow-hidden w-max">
            <select name="delivery" id="delivery" className="px-5 py-5 border-0 appearance-none w-56 font-bold block">
